...
namespace Runtime.UI.MainMenuUI.ProgressPath
{
    public class RewardPopUpManager : MonoBehaviour
    {
        ...
        [SerializeField] 
        private CoinRewardPopup _coinRewardPopup;
   
        [SerializeField] 
        private RankRewardPopup _rankRewardPopup;
    
        [SerializeField] 
        private ChefRewardPopup _chefRewardPopup;
    
        [SerializeField] 
        private RecipeRewardPopup _recipeRewardPopup;
