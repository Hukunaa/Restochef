...
{
    public class SwipeMenuLayout : MonoBehaviour, IPointerDownHandler, IDragHandler, IPointerUpHandler
    {
        ...
        private void Start()
        {
            ...
            _tabTransforms.Add(_tabManager.BrigadeTab.GetComponent<MainMenuTab>());
            _tabTransforms.Add(_tabManager.KitchenTab.GetComponent<MainMenuTab>());
            _tabTransforms.Add(_tabManager.MenuTab.GetComponent<MainMenuTab>());
            _tabTransforms.Add(_tabManager.MarketTab.GetComponent<MainMenuTab>());
            _tabTransforms.Add(_tabManager.CookTab.GetComponent<MainMenuTab>());
        ...
        public void ShowLayout()
        {
            ...
            _rect.sizeDelta = new Vector2(_width * _rect.transform.childCount, _rect.sizeDelta.y);
            _canvasGroup.DOKill();
        ...
        private void Update()
        {
            ...
            float a = -((_width * _rect.transform.childCount / 2) - _width / 2);
            float b = (_width * _rect.transform.childCount / 2) - _width / 2;
