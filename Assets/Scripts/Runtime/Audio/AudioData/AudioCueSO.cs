...
namespace Runtime.Audio.AudioData
{
	/// <summary>
	...
	public class AudioCueSO : ScriptableObject
	{
		...
		public bool _resetPlayingOrder = true;
	
		public void ResetAudioClipsGroupPlayingOrder()
		{
			//_audioClipGroups.ForEach(x => x.ResetClipOrder());
		}
